...
export class Cards {
  ...
  GetGeneralAverageScore() {
    this.GeneralAverage = this._userservice.GetStudentGeneralAverageScore(
      this.student.submittedTasks,
      this.student.class.subjects,
      this.Unit()
    );
  }
  ...
  GetTasks() {
    ...
    this.TasksCount = this._taskservice.VerifyPendingTestOrSubmitted(
      this.Tasks,
      this.student.submittedTasks,
      this.academic()
    ).length;
